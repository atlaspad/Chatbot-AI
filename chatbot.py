    ...
    try:
        ...
        if "atlaspad" in message.lower():
            if "atlaspad nedir" in message.lower():
                ...
                return "Atlaspad is the ZK-Launchpad technology used in Mina Protocol. Introducing ZK Launchpad, the first and only trusted Cross-Chain that uses zero-knowledge proofs to enable secure and private transactions across multiple blockchains. This cutting-edge platform addresses pressing privacy issues and high transaction costs in DeFi by allowing users to."
            ...
            elif "why was atlaspad designed" in message.lower():
                return "This launchpad is designed to provide users with the freedom to move assets between chains privately and efficiently, fostering a new paradigm in the DeFi space where privacy and cross-chain functionality seamlessly coexist."
